...
def compute_brier_score(
    ...
    Args:
        forecasts: DataFrame with columns (forecaster, event_ticker, round, prediction, outcome, weight)
        append: If True, append the Brier score to the original forecasts DataFrame. If False, return a new DataFrame.
    """
    if append:
    ...
    if append:
        ...
        all_columns = list(set(DEFAULT_BRIER_RESULT_COLUMNS + additional_columns))
